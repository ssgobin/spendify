  ...
  try {
    ...
    const planInfo = {
      ...
      none: {
        ...
        price: "Gratuito",
        icon: "📋",
        features: ["Acesso limitado", "Sem recorrências", "Sem metas"]
      }
    };
    ...
    if (window.Swal && Swal.fire) {
      ...
      const res = await Swal.fire({
        ...
        preConfirm: () => {
          ...
          const amount = Number(document.getElementById("limitAmount")?.value || 0);
          if (!cat) {
    ...
    if (window.Swal && Swal.fire) {
      ...
      const res = await Swal.fire({
        ...
        preConfirm: () => {
          ...
          const category = document.getElementById("recCat")?.value?.trim() || "";
          const dayOfMonth = Number(document.getElementById("recDay")?.value || 1);
